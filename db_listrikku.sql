...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 31, 2025 at 04:31 PM
...
('PLG2401200001', 'MasDim', 'masdim6699', '$2y$10$2EmzDdZ5idUH8MjqhEZTxOglyiANROFCCjUihwav8iHMTfp3N7SSq', '56906999460', 'Jl Surga', 'TRF20230205009'),
('PLG2407160001', 'ragil', 'ragil6699', '$2y$10$EoUg7Rq01cOXpAkXmgemiel4I9z60hr0JyJXX7wMFKBfdidSi0jou', '089675645', 'Jakarta Utara', 'TRF20230205010');
...
CREATE TABLE `pembayaran` (
  ...
  `id_tagihan` varchar(128) DEFAULT NULL,
  `id_pelanggan` varchar(128) DEFAULT NULL,
...
('PAY240120001', 'TG202401211', 'PLG2401200001', '2024-01-20', 2500, 202500, 'ADM0000'),
('PAY240125001', 'TG202401251', 'PLG2401200001', '2024-01-01', 2500, 10802500, 'ADM0000'),
('PAY240716001', 'TG202407161', 'PLG2407160001', '2024-07-16', 2500, 1082500, 'ADM0000'),
('PAY240806001', 'TG202408061', 'PLG2407160001', '2024-08-06', 2500, 272500, 'ADM0000');
...
('PN240120003', 'PLG2401200001', 12, 2023, 15500, 15600),
('PN240125001', 'PLG2401200001', 12, 2023, 15600, 21000),
('PN240806001', 'PLG2407160001', 7, 2024, 100, 200);

--
-- Triggers `penggunaan`
--
DELIMITER $$
CREATE TRIGGER `penggunaan_new` AFTER INSERT ON `penggunaan` FOR EACH ROW BEGIN
    DECLARE new_id_tagihan VARCHAR(128);
    DECLARE existing_count INT;

    SELECT COUNT(*) INTO existing_count
    FROM tagihan
    WHERE LEFT(id_tagihan, 10) = CONCAT('TG', DATE_FORMAT(CURDATE(), '%Y%m%d'));

    SET new_id_tagihan = CONCAT('TG', DATE_FORMAT(CURDATE(), '%Y%m%d'), existing_count + 1);

    INSERT INTO tagihan (id_tagihan, id_penggunaan, id_pelanggan, bulan, tahun, jumlah_meter, status)
    VALUES (new_id_tagihan, NEW.id_penggunaan, NEW.id_pelanggan, NEW.bulan, NEW.tahun, NEW.meter_akhir - NEW.meter_awal, 'UNPAID');
END
$$
DELIMITER ;
...
('TG202401211', 'PN240120003', 'PLG2401200001', 12, 2023, 100, 'PAID'),
('TG202401251', 'PN240125001', 'PLG2401200001', 12, 2023, 5400, 'PAID'),
('TG202408061', 'PN240806001', 'PLG2407160001', 7, 2024, 100, 'PAID'),
...
('USR0001', 'Admin', '$2a$12$wsUswqTBEt9xzgXGyx/6S.bPsGsWJPMLRoxDUCgYNwdSqjQzrXDrO', 'Petugas', 'LVL001'),
('USR0002', 'petugas_admin', '$2a$12$4R87P2/87MsAFvtsbNE3DelESy9CdLyIk5BMq16J3CJb40xpAlz/S', 'Petugas', 'LVL002'),
...
ALTER TABLE `penggunaan`
  ...
  ADD KEY `idx_penggunaan_pelanggan` (`id_pelanggan`);
